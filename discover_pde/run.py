...
integration_grid = EquiPartGrid(widths, integration_samples)
...
estimated_dataset = estimate_fields(observed_grid, observed_dataset, integration_grid, seed=0)

fig, ax = plt.subplots(subplot_kw={"projection": "3d"})
surf = ax.plot_surface(integration_grid.by_axis()[0], integration_grid.by_axis()[1], estimated_dataset[0][0],
